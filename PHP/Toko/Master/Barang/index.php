...
echo "<a href='tambahBarang.php'><button>+</button></a>";
echo "<table border='1'>";
...
if(mysqli_num_rows($result) > 0){
  ...
  while($row = mysqli_fetch_assoc($result)){
    ...
    echo "<td>";
    echo "<a href='updateBarang.php?kode_barang=" . $row["kode_barang"] . "'><button>U</button></a>";
    echo "<div style='display:inline-block; width:10px;'></div>";
    echo "<a href='hapusBarang.php?kode_barang=" . $row["kode_barang"]."'><button>-</button></a>";
    echo "</td>";
    echo "</tr>";
